          ...
          {products.length === 0 && inputValue && (
            <div className="flex flex-col justify-center items-center mx-10 -mt-20 -z-10">
              ...
              <p className="text-base font-mono font-light text-center md:mx-40 md:text-lg xl:mx-80">
                La ricerca del prodotto non è andata a buon fine in quanto non è
                attualmente disponibile presso il nostro negozio. Ci scusiamo
                per l&apos;inconveniente. Tuttavia, potrebbe essersi verificato
                un errore nella digitazione del nome del prodotto.
              </p>
            </div>
          )}
        </>
